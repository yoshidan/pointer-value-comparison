...
func (r *PtrSampleRepository) FindByPK(groupID int64, sampleID int64) (*Sample, error) {
	...
	case [2]int64{1, 1}:
		return &Sample{1, 1, 1, 3}, nil
	case [2]int64{1, 2}:
		return &Sample{1, 2, 2, 3}, nil
	case [2]int64{1, 3}:
		return &Sample{1, 3, 3, 3}, nil
	case [2]int64{1, 4}:
		return &Sample{1, 4, 4, 3}, nil
	case [2]int64{1, 5}:
		return &Sample{1, 5, 5, 3}, nil
	case [2]int64{1, 6}:
		return &Sample{1, 6, 6, 3}, nil
	case [2]int64{1, 7}:
		return &Sample{1, 7, 7, 3}, nil
	case [2]int64{1, 8}:
		return &Sample{1, 8, 8, 3}, nil
	case [2]int64{1, 9}:
		return &Sample{1, 9, 9, 3}, nil
	case [2]int64{1, 10}:
		return &Sample{1, 10, 10, 3}, nil
	case [2]int64{1, 11}:
		return &Sample{1, 10, 11, 3}, nil
	case [2]int64{1, 12}:
		return &Sample{1, 10, 11, 3}, nil
	case [2]int64{1, 13}:
		return &Sample{1, 10, 11, 3}, nil
